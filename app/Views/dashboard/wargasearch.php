        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Cari Warga</h1>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
      <form class="needs-validation" role="form"  name="formcari" method="POST" enctype="multipart/form-data" autocomplete="on">
      <div class="row">
          ...
          <span id="loader" role="status" aria-hidden="true"></span>
					<span class="sr-only">Loading...</span>CARI
        </button>
